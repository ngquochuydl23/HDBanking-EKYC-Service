...
import com.socialv2.ewallet.ui.customAdapter.FragmentQrAdapter;
...
public class QRPaymentActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mViewPager2 = findViewById(R.id.view_pager_2_qr);

        FragmentQrAdapter fragmentQrAdapter = new FragmentQrAdapter(this);
        mViewPager2.setAdapter(fragmentQrAdapter);
